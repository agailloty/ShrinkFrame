...
Immich: 50-item explicit pages, filters for taken period, size, album and sort, thumbnails through ShrinkFrame, detail panel, persistent cross-page selection, Select Page and Clear Selection. No video playback in the POC.
